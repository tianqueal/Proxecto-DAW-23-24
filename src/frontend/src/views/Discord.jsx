  ...
  <section role="complementary" className="mt-12 text-center">
    ...
    >
      ...
      <Link
        to={DiscordClientURL()}
        target="_blank"
        className="inline-block rounded-md border bg-blue-600 px-4 py-2 text-sm font-medium text-white shadow-sm transition-all duration-300 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 dark:bg-blue-500 dark:hover:bg-blue-600"
      >
        Únete a Discord
      </Link>
    </motion.div>
